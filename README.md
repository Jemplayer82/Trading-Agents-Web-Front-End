...
- **Hourly marks** (10:00–16:00 + 16:45 ET) now enforce the **stop-loss intraday** like a standing stop order: a fresh quote crossing −60% closes the position at the stop level (or at the observed quote when it gapped through); stale/carried marks never trigger. A **20:00 ET expiry settlement** sweep models OCC auto-exercise (ITM ≥ $0.01 settles at intrinsic vs the last close on/before expiry)
